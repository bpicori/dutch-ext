...
import { dialogueReplyModule, enToNlModule, enToNlSentenceModule, fillBlankModule, knmModule, nlToEnModule, nlToEnSentenceModule, numberDetailModule, prepositionModule, readMcqModule, verbFormModule, } from './mcq.js';
...
export const CHALLENGE_TYPES = Object.keys(Registry);
